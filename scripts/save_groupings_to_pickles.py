...
species_dict = {
    "ath":"../data/pathway_related_files/plantcyc/aracyc_pathways.20180702", 
    "zma":"../data/pathway_related_files/plantcyc/corncyc_pathways.20180702", 
    "mtr":"../data/pathway_related_files/plantcyc/mtruncatulacyc_pathways.20180702", 
    "osa":"../data/pathway_related_files/plantcyc/oryzacyc_pathways.20180702", 
    "gmx":"../data/pathway_related_files/plantcyc/soycyc_pathways.20180702",
    "sly":"../data/pathway_related_files/plantcyc/tomatocyc_pathways.20180702"}
...
df = pd.read_csv("../data/pathway_related_files/lloyd/lloyd_gene_to_function_irb_cleaned.csv")
